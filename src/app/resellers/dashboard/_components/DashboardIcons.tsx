...
/** Lucide file-text — shared paths for quick actions, resource cards, spec sheet headers */
...
/** Smaller file-text for asset library list card headers */
...
/** Lucide download — asset list row actions */
export function IconDownload({ className }: { className?: string }) {
  return (
    <svg
      ...
      strokeLinecap="round"
      strokeLinejoin="round"
      className={cn("h-4 w-4 shrink-0 text-zinc-400", className)}
      aria-hidden
    >
      <path d="M12 15V3" />
...
export function QuickActionIcon({
  ...
  const base = cn("h-5 w-5 text-red-600", className);
  switch (name) {
    case "quote":
    case "file-text":
      return <IconFileText className={base} />;
    case "deal":
      return (
        <svg
          xmlns="http://www.w3.org/2000/svg"
    ...
    case "trending-up":
      return <IconTrendingUp className={base} />;
    case "phone":
      return (
    ...
    case "image":
    case "megaphone":
      return <IconMegaphone className={base} />;
    default:
      return (
        <svg className={base} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden>
...
/** Icons inside light-red badge on resource & training cards */
...
/** Graduation cap — training panel header & rows */
export function TrainingIcon({ className }: { className?: string }) {
  return (
    <svg
...
/** Sparkles — Partner announcements panel header */
