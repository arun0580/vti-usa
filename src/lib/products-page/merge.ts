...
export function mergeProductsContent(
  stored?: Partial<ProductsPageContent> | null,
): ProductsPageContent {
  if (!stored) return defaultProductsContent;
  return mergeDeep(defaultProductsContent, stored);
}
